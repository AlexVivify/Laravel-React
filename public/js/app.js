...
var Tasks = function (_Component) {
    ...
    _createClass(Tasks, [{
        ...
        value: function componentWillMount() {
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get("/api/tasks").then(function (response) {
                _this2.setState({
                    tasks: response.data
                });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Tasks__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_router_dom__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Example__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Task__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_NewTask__ = __webpack_require__(93);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["d" /* Route */], { path: "/", exact: true, component: __WEBPACK_IMPORTED_MODULE_4__components_Example__["default"] }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["d" /* Route */], { path: "/tasks", exact: true, component: __WEBPACK_IMPORTED_MODULE_2__components_Tasks__["a" /* default */] }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["d" /* Route */], { path: "/tasks-create", exact: true, component: __WEBPACK_IMPORTED_MODULE_6__components_NewTask__["a" /* default */] }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["d" /* Route */], {
                            path: "/tasks/:id",
                            exact: true,
                            render: function render(props) {
                                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_Task__["a" /* default */], props);
                            }
                        })
                    )
                )
...
if (document.getElementById("example")) {
    __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Index, null), document.getElementById("example"));
}
...
var Task = function (_Component) {
    ...
    _createClass(Task, [{
        ...
        value: function componentDidMount() {
            ...
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get("/api/tasks/" + this.props.match.params.id).then(function (response) {
                _this2.setState({ task: response.data });
        ...
        value: function handleDelete() {
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.delete("/api/tasks/" + this.props.match.params.id).then(function (response) {
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["c" /* Redirect */], { to: "/api/tasks" });
            }).catch(function (error) {
                console.log(error);
            });
        }
...
var NewTask = function (_Component) {
    ...
    _createClass(NewTask, [{
        ...
        value: function handleSubmit(e) {
            e.preventDefault();
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post("/api/tasks", this.state).then(function (response) {
                alert("Task created successfuly");
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["c" /* Redirect */], {
                    to: {
                        pathname: "/"
                    }
                });
